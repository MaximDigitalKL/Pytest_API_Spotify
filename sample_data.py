...
class SpotifyAlbum:
    ...
    @classmethod
    def missing_album_id(cls):
        return '5eA0qtE7Yu29XiMlwoby2Gy'
    
    @classmethod
    def several_album_ids(cls):
          ids = ('5eA0qtE7Yu29XiMlwoby2G', '4Gfnly5CzMJQqkUFfoHaP3', '2Lq2qX3hYhiuPckC8Flj21',)
          return ",".join(ids)
    
    @classmethod
    def several_album_names(cls):
          names = ("Nevermind (30th Anniversary Super Deluxe)", "Meteora", "Master Of Puppets (Remastered)",)
          return names
